  ...
  <v-row align="center" justify="center">
    <v-col cols=12>
      ...
      <v-card-text>
        ...
        ENAC studying distributed computing in dynamic networks.
        </div>
        <div class="overline mt-3 teal--text">TECH INTERESTS</div>
        <div >
          <ul class="body-2">
        ...
        <div>
          <ul class="body-2 mb-4">
            <li>Programming language skills in C, Python and JS (Backend with Node.JS and Frontend with Vue) and programming in general being open to always learn new technologies</li>
            <li>Growing interest in distributed algorithms</li>
